...
public class NotificationUtils {
    ...
    private static final int IGNORE_PENDING_INTENT_ID = 888;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 444;
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, IGNORE_PENDING_INTENT_ID,
