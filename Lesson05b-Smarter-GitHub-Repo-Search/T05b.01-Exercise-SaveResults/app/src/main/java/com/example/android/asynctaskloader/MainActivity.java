...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String QUERY_URL_KEY = "github_query_url";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String RESULTS_JSON_KEY = "json_results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            if(savedInstanceState.containsKey(RESULTS_JSON_KEY)){
                mSearchResultsTextView.setText(RESULTS_JSON_KEY);
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(RESULTS_JSON_KEY, json);
    }
